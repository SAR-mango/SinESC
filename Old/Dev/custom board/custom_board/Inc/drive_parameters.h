...
#define MAX_APPLICATION_SPEED_RPM       42400 /*!< rpm, mechanical */
...
#define SW_DEADTIME_NS                   350 /*!< Dead-time to be inserted
...
#define PID_TORQUE_KI_DEFAULT         3976
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2130
#define PID_FLUX_KI_DEFAULT           3976
...
#define PID_SPEED_KP_DEFAULT          2218/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          288/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
