# Overview
SinESC is an electronic speed controller (ESC) that supports full sinusoidal control of brushless DC motors . RC drones and wings are the target application of SinESC.
